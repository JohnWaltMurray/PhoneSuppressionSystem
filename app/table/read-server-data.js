        ...
        read_data_html+="<table class='table table-bordered table-hover'>";
            ...
            $.each(data.records, function(key, val) {
                ...
                read_data_html+="<tr>";
                    ...
                    // DATA HERE
                    read_data_html+="<td class='data-id'>" + val.id + "</td>";
                    ...
                    // 'action' buttons
                    read_data_html+="<td>";
                        read_data_html+="<button class='btn btn-primary m-r-10px read-one-button' data-id='" + val.id + "'>";
                            read_data_html+="<span class='glyphicon glyphicon-eye-open'></span> Read";
                        read_data_html+="</button>";
            
                        read_data_html+="<button class='btn btn-info m-r-10px update-button' data-id='"+val.id+"'>";
                            read_data_html+="<span class='glyphicon glyphicon-edit'></span> Edit";
                        read_data_html+="</button>";
            
                        read_data_html+="<button class='btn btn-danger delete-entry-button' data-id='"+val.id+"'>";
