...
function showTable() {
    $.getJSON("http://localhost/PhoneSuppressionSystem/app/contact/read.php", function(data){
        ...
        read_data_html+="<div id='create-row' class='btn btn-primary pull-right m-b-15px create-product-button'>";
            ...
            $.each(data.records, function(key, val) {
                ...
                read_data_html+="<tr>";
                    ...
                    read_data_html+="<td>";
                        ...
                        // edit button
                        read_data_html+="<button class='btn btn-info m-r-10px update-product-button'>";
                            read_data_html+="<span class='glyphicon glyphicon-edit'></span> Edit";
                        read_data_html+="</button>";
            
                        // delete button
                        read_data_html+="<button class='btn btn-danger delete-product-button'>";
